...
public class ExpenseDetailsDbHelper extends SQLiteOpenHelper {
    public static final String TABLE_NAME = "expense";
    public static final String COLUMN_NAME_SOURCE = "reason";
    public static final String COLUMN_NAME_AMOUNT = "expense";
    ...
    public ExpenseDetailsDbHelper(Context context) {
    ...
    public void add(String reason,String amount, String date){
        // Gets the data repository in write mode
        SQLiteDatabase db = this.getWritableDatabase();
        // Create a new map of values, where column names are the keys
        ContentValues values = new ContentValues();
        values.put(COLUMN_NAME_SOURCE, reason);
        values.put(COLUMN_NAME_AMOUNT, amount);
        values.put(COLUMN_NAME_DATE, date);
        // Insert the new row, returning the primary key value of the new row
        long newRowId = db.insert(TABLE_NAME, null, values);
    }
    public ArrayList<ExpenseDetails> get(){
        // Gets the data repository in get mode
        SQLiteDatabase db = this.getWritableDatabase();
        ArrayList<ExpenseDetails>  newArrayList= new ArrayList<>();
    ...
    public void update(String reason,String amount, String date, String id) {
